# Generated by Django 6.1.1 on 2026-09-10 16:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover', models.ImageField(blank=True, null=True, upload_to='books/', verbose_name='Обкладинка')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reader', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='borrowings', to=settings.AUTH_USER_MODEL, verbose_name='Читач')),
            ],
            options={
                'verbose_name': 'Позика',
